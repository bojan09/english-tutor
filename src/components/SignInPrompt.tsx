  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full space-y-8 animate-fade-in">
        ...
        {/* Sign-In Card */}
        <Card className="bg-white/80 backdrop-blur-sm shadow-lg rounded-xl border border-blue-100">
          ...
          <CardContent className="space-y-4 pt-4">
            <SignIn
              appearance={{
                elements: {
                  formButtonPrimary:
                    "bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white w-full rounded-lg shadow-md hover:shadow-lg transition-all duration-300",
                  footerAction: "text-blue-600 hover:text-blue-700 font-medium",
                  socialButtonsBlockButton:
                    "bg-gray-100 hover:bg-gray-200 text-gray-900 border-gray-300 rounded-lg",
                  input:
                    "bg-white/50 border border-gray-200/50 text-gray-900 placeholder-gray-400 focus:ring-blue-400/50 focus:border-blue-400/50",
                },
              }}
            />
